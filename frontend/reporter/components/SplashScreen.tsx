//START OF components\SplashScreen.tsx
"use client"
...
const SplashScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen animate-fadeIn p-4 bg-[#0F2230]">
      ...
      <h1 className="text-2xl md:text-3xl font-bold text-center text-[#F5F5F5] tracking-tight">{t("title")}</h1>
      <p className="text-lg md:text-xl text-gray-300 mt-2 font-light">{t("subtitle")}</p>
      <style>{`
        @keyframes fadeIn {
...
//END OF components\SplashScreen.tsx